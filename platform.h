...
#define SEMU_PLATFORM_MMIO_VGPU_HOSTMEM_BASE UINT64_C(0xF8000000)
#define SEMU_PLATFORM_VGPU_HOSTMEM_SIZE UINT64_C(0x04000000)

#define SEMU_PLATFORM_DEVICE_COUNT 15U
